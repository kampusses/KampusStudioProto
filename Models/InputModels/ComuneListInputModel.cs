...
namespace KampusStudioProto.Models.InputModels
{
    ...
    {
        public ComuneListInputModel(string search, string searchtype, int page, string orderby, bool ascending, IConfiguration configuration)
        {
            //sanitizzazione
            if (search == null) Search = "";
            else Search = search;
            if (searchtype == null || (searchtype != "Nome comune" && searchtype != "CAP" && searchtype != "Prefisso" && searchtype != "Belfiore" && searchtype != "Provincia" && searchtype != "Regione")) SearchType = "Nome comune";
