    ...
    public class GenerateRecoveryCodesModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (!isTwoFactorEnabled)
            {
                ...
                throw new InvalidOperationException($"Impossibile generare codici di ripristino per l'utente con ID '{userId}' perché non ha 2FA abilitato.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!isTwoFactorEnabled)
            {
                throw new InvalidOperationException($"Impossibile generare codici di ripristino per l'utente con ID '{userId}' poiché non ha 2FA abilitato.");
            }
