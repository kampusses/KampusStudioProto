...
namespace KampusStudioProto.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "La {0} deve essere lunga almeno {2} e max {1} caratteri.", MinimumLength = 8)]
            [DataType(DataType.Password)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("L'utente ha cambiato la propria password con successo.");
            StatusMessage = "La tua password è stata modificata.";
